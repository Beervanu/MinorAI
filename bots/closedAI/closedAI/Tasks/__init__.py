...
DO_ONCE_TASKS = []
for module_name in ['find_ore', 'found_ti_ore', 'build_bridge', 'attack_enemy_core', 'place_sentinel', 'find_enemy_core', 'cutoff_enemy_turret', 'heal', 'build_core_defense', 'cutoff_enemy_lines', 'get_rid_of_intruders']:
