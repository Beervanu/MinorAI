...
ESSENTIAL_TASKS = [BuilderTask.CUTOFF_ENEMY_TURRET, BuilderTask.HEAL, BuilderTask.BUILD_CORE_DEFENCE, BuilderTask.BUILD_BRIDGE, BuilderTask.GET_RID_OF_INTRUDERS]